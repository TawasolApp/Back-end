...
STRIPE_WEBHOOK_SECRET=whsec_jiQNqBUQvMODKIGPVYoPFpItYExSijC6
PAYMENT_SUCCESS_URL=https://tawasolapp.me/current-plan
PAYMENT_CANCEL_URL=https://tawasolapp.me/rejected-plan
```
